...
fields_mapping = {
    ...
    'show_cells': 'show cells',
    'overlay_currents': 'overlay currents',
    'streamline_density': 'streamline density',
    'plot_total_current': 'plot total current',
    'plot_cutlines': 'plot cutlines',
    'plot_masked_geometry': 'plot masked geometry',
    'default_colormap': 'default colormap',
    'background_colormap': 'background colormap',
    'network_colormap': 'network colormap',
    'gj_colormap': 'gj colormap',
    'vector_and_stream_color': 'vector and stream color',
    'plot_networks': 'plot networks',
    'plot_networks_single_cell': 'plot networks single cell',
    'cell_indices': 'cell indices',
    'single_cell': 'single cell',
    'while_solving': 'while solving',
    'after_solving': 'after solving',
    'single_cell_pipeline': 'single cell pipeline',
    'cell_cluster_pipeline': 'cell cluster pipeline',
    'plot_cluster_mask': 'plot cluster mask',
