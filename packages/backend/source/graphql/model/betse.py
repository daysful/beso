...
def modelBetseSimulation(
    ...
    model['data']['results_options']['while_solving']['animations'] = BetseSimulationResultsOptionsWhileSolvingAnimations(**model['data']['results_options']['while_solving']['animations'])
    ...
    model['data']['results_options']['after_solving']['csvs']['pipeline'] = []
    ...
    model['data']['results_options']['after_solving']['plots']['single_cell_pipeline'] = []
    ...
    model['data']['results_options']['after_solving']['plots']['cell_cluster_pipeline'] = []
    ...
    model['data']['results_options']['after_solving']['animations']['pipeline'] = []
    ...
    model['data']['results_options']['save']['csvs'] = BetseSimulationResultsOptionsSaveCsvs(**model['data']['results_options']['save']['csvs'])
    model['data']['results_options']['save']['plots'] = BetseSimulationResultsOptionsSavePlots(**model['data']['results_options']['save']['plots'])
    model['data']['results_options']['save']['animations']['images'] = BetseSimulationResultsOptionsSaveAnimationsImages(**model['data']['results_options']['save']['animations']['images'])
    model['data']['results_options']['save']['animations']['video']['metadata'] = BetseSimulationResultsOptionsSaveAnimationsVideoMetadata(**model['data']['results_options']['save']['animations']['video']['metadata'])
    model['data']['results_options']['save']['animations']['video'] = BetseSimulationResultsOptionsSaveAnimationsVideo(**model['data']['results_options']['save']['animations']['video'])
    model['data']['results_options']['save']['animations'] = BetseSimulationResultsOptionsSaveAnimations(**model['data']['results_options']['save']['animations'])
